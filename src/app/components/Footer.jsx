...
export default function Footer() {
    return (
        <div className='bg-black relative overflow-hidden '>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-green-900/20 via-green-500/10 to-green-900/20 blur-3xl"></div>
            <div className="absolute bottom-0 left-1 w-96 h-96 bg-green-500/20 rounded-full blur-3xl"></div>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-between'>
                        ...
                        <div className='w-full md:w-1/2'>
                            ...
                            <div className="flex space-x-4">
                                <Link href="https://facebook.com" className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
                                    <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                    </svg>
                                </Link>

                                <Link href="https://instagram.com" className="w-10 h-10 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-500 transition-colors">
                                ...
                                <Link href="https://twitter.com" className="w-10 h-10 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-500 transition-colors">
                                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
