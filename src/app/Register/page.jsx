        ...
        <div className="p-8 lg:p-12 space-y-8 relative z-10">
          <div className="space-y-2 text-center">
            ...
            <p className="text-gray-400">
              ...
              <Link 
                href="/Login" 
                className="text-green-400 hover:text-green-300 transition-colors relative z-20"
              >
                Login here
              </Link>
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black/30 border border-green-500/30 rounded-full pl-12 pr-12 py-4 text-white placeholder-gray-400 focus:border-green-400 focus:outline-none transition-colors relative z-10"
                  required
                  minLength={6}
                />
                <button
            ...
            {/* <label className="flex items-start space-x-3 cursor-pointer relative z-10">
              <div className="relative mt-1">
                <input
                  ...
                  className="sr-only"
                />
                <div className="w-4 h-4 border-2 rounded border-gray-500 bg-black/30 transition-colors">
                  <svg className="w-3 h-3 text-green-500 absolute top-0.5 left-0.5 hidden checkmark" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-green-500 hover:bg-green-600 text-black font-semibold py-4 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed relative z-10"
            >
